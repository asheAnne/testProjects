...
class RaceIntegrationTests extends GroovyTestCase {
 ...
 void testRaceDatesBeforeToday(){
  ...
  assertFalse "Validation should not succeed", rece.validate()
  assertTrue "There should be errors", race.hasErrors()

  println "\nErrors: "
  println rece.errors ?: "no errors found"
  ...
  println "\nCode: "
  println code ?: "the custome validator for startDate wasn't found"
